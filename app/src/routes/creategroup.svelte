...
<main class="container pt-4">
	{#if userName}
		{#if !done}
			...
			{:else if role == 'university'}
				...
				<div>
					...
					<br /><a href="mailto:lightbulb-learning@robertnickel.online">Contact us</a> for pricing information,
					a complete feature list and to tell us your requirements for the system.
				</div>
		...
		{:else}
			<h1>Group created!</h1>
			<div class="mb-4">
				Share <kbd>{groupName}</kbd><br /> with your students, so they can join the group.
			</div>
